...
function Result() {
    return (
        <>
            <div className='mb-10'>
                <div className=''>
                    <button className='border-2 bg-white p-2 rounded-lg flex'><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
                ...
                <div className='bg-white border-4 rounded-3xl w-[350px] h-[350px] p-5'>
                    ...
                    <div className='grid gap-[180px]'>
                        ...
                        <div className='flex border-t-2 border-black pt-2 text-[20px]'>
                            ...
                            <p className='ml-5'>2024/05/25</p>
                        </div>
                    </div>
                </div>
                <div className='relative bg-white border-4 rounded-3xl	 w-[350px] h-[350px] '>
                    <div>
